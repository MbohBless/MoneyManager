package github.groupa.fintech.database;
...
import github.groupa.fintech.savings.SavingsModelClass;
import github.groupa.fintech.scope.ScopeModelClass;
import github.groupa.fintech.overview.OverviewModelClass;
...
public class DatabaseClass extends SQLiteOpenHelper{
    ...
    //Database Name
    private static final String DATABASE_NAME = "groupADatabase";
    //Table Names
    ...
    public long updateFromOverview(OverviewModelClass element) {
        ...
        String table = null;
        System.out.println("THIS IS TO SHOW THE TABLE NAME:"+element.getTvDomain());

        if(element.getTvDomain().equals("Income")) {
        ...
        return db.update(table, val, KEY_ID + " = "+element.getId(), null);
