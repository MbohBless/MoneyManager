...
import github.groupa.fintech.statistics.SortData.SortMode;
...
public class StatisticsFragment extends Fragment {
    ...
    private String[] sortParameters = {"Period Desc.", "Period Asc." , "Sum Desc.", "Sum Asc.","A-Z","Z-A"};
...
//        getParentFragmentManager().beginTransaction().detach(this).attach(this).commit();
        ...
        if(sortParam.equals("Period Asc."))Collections.sort(statisticsModelClasses, new SortMode((byte)2));
        if(sortParam.equals("Period Desc."))Collections.sort(statisticsModelClasses, new SortMode((byte)3));
        if(sortParam.equals("Sum Desc."))Collections.sort(statisticsModelClasses, new SortMode((byte)0));
        if(sortParam.equals("Sum Asc."))Collections.sort(statisticsModelClasses, new SortMode((byte)1));
