...
import github.groupa.fintech.overview.SortData.SortMode;
...
public class OverviewFragment extends Fragment {
    ...
    public void showOverviewData(View view, int month, int year, String sortParam){
        ...
        if(overviewModelClasses!=null) {
            ...
            if(sortParam.equals("Period Asc.")) Collections.sort(overviewModelClasses, new SortMode((byte) 2));
            if(sortParam.equals("Period Desc.")) Collections.sort(overviewModelClasses, new SortMode((byte)3));
            if(sortParam.equals("Sum Asc.")) Collections.sort(overviewModelClasses, new SortMode((byte) 0));
            if(sortParam.equals("Sum Desc.")) Collections.sort(overviewModelClasses, new SortMode((byte) 1));
